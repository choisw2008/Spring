...
public class MemberController {
	...
	@RequestMapping(value = "/DropDownMenu1", method = RequestMethod.GET)
	public String getDropDownMenu1() throws Exception {
		logger.info("MemberController getDropDownMenu1().....");
		return "/member/DropDownMenu1"; // => WEB-INF/views/member/register.jsp
	}
	
	// DropDown Menu Multi Level
	@RequestMapping(value = "/DropDownMenu2", method = RequestMethod.GET)
	public String getDropDownMenu2() throws Exception {
		logger.info("MemberController getDropDownMenu2().....");
		return "/member/DropDownMenu2"; // => WEB-INF/views/member/register.jsp
	}
